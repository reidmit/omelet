...
var typeRe = new RegExp(/\s([a-z|A-Z]+)/)
function typeOf(obj) {
    return ({}).toString.call(obj).match(typeRe)[1]
}
...
/*
 * sortby: sort an Array of Dictionaries by a given property
 */
module.exports.sortby = function(input, prop) {
...
module.exports.map = function(input, seq) {
    var type = typeOf(input)
    if (type === 'String') {
        input = input.split('')
    } else if (type !== 'Array') {
