  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c48 = function(id, context) {
                if (id.kind === "Path") {
                    throw SyntaxError("Invalid include statement '>include "+id.value+"'. To include an external file, use '>include "+id.value+"'.")
                }
                return {
                    kind: "Include",
                    included: id,
        ...
        peg$c103 = function(openTag, r) {return r},
        peg$c104 = function(openTag, r) {
                if (isArray(openTag)) {
                    var o = {
                        kind: "Tag",
                        name: openTag[0].value,
        ...
        peg$c105 = function(openTag, line) {
                if (isArray(openTag)) {
                    var o = {
                        kind: "Tag",
                        name: openTag[0].value,
        ...
        peg$c106 = function(openTag, inner) {
                if (isArray(openTag)) {
                    var o = {
                        kind: "Tag",
                        name: openTag[0].value,
        ...
        peg$c111 = function(tagName, specialAttrs, attrList) {
        ...
        peg$c118 = function(attrs) { return attrs.map(function(a) { return a[0] }) },
        peg$c119 = { type: "other", description: "an attribute" },
        peg$c120 = function(attrName, attrValue) {
                return {
                    kind: "Attribute",
                    name: attrName,
                    value: attrValue,
        ...
        peg$c137 = "@doctype ",
        peg$c138 = { type: "literal", value: "@doctype ", description: "\"@doctype \"" },
        ...
        peg$c140 = { type: "other", description: "a path to a file or directory" },
        peg$c141 = "/",
        ...
        peg$c149 = function(prefix, part0, parts, ext, final) {
        ...
        peg$c159 = { type: "other", description: "a number" },
        peg$c160 = /^[0-9]/,
        peg$c161 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c162 = function(minus, integer, decimal) {
                var value;
                if (decimal === null) {
        ...
        peg$c163 = { type: "other", description: "a boolean value" },
        peg$c164 = "true",
        peg$c165 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c166 = "false",
        peg$c167 = { type: "literal", value: "false", description: "\"false\"" },
        ...
        peg$c173 = { type: "other", description: "an indent" },
        peg$c174 = "\u21D2",
        peg$c175 = { type: "literal", value: "\u21D2", description: "\"\\u21D2\"" },
        peg$c176 = { type: "other", description: "a dedent" },
        peg$c177 = "\u21D0",
        ...
        peg$c187 = { type: "other", description: "plain text" },
        peg$c188 = /^[^\u21D0\u21D2@{}\\#+]/,
        peg$c189 = { type: "class", value: "[^\u21D0\u21D2@{}\\\\#+]", description: "[^\u21D0\u21D2@{}\\\\#+]" },
        peg$c190 = function(text) {
                return {
                    kind: "String",
                    value: text.join(""),
                    //location: location()
