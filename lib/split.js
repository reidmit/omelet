...
var Splitter = function(outputDirectory, cacheDirectory) {
    ...
    function writeFiles(fileInfo, context) {
        context = context || {};
        ...
        for (var i=0; i<fileInfo.length; i++) {
            ...
            if (!file.isHidden) {
                ...
                rd.renderString(file.contents, file.parser, context, file.filePath, fullPath);
            }
        }
    }

    this.splitAndRender = function(filePath, context) {
        var input = "";
        ...
        mkdirp(outputDirectory, function (err) {
            ...
            writeFiles(fileTreeInfo, context);
        });
    }
}
