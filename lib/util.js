...
util.mergeClassAttributes = function(attrList) {
...
util.insertInnerAndAttrs = function(tagNode, newInner, newAttrs) {
    if (tagNode.inner.contents.length === 0) {
        tagNode.inner = newInner
        tagNode.attributes = util.mergeClassAttributes(
                                tagNode.attributes.concat(newAttrs))
    } else if (tagNode.inner.contents[0].kind === 'Tag') {
        util.insertInnerAndAttrs(tagNode.inner.contents[0], newInner, newAttrs)
    }
}
